...
const Navbar = () => {
  ...
  return (
    <div
      className="flex justify-between items-center absolute gap-[55px] w-full  px-[50px] font-bold border-b-2"
                  ...
                  <>
                    <div>
                      {auth.isAuthenticatedAdmin ? (
                        <a className="hover:text-blue-300" href="/admin">
                          Dashboard
                        </a>
                      ) : (
                        <a className="hover:text-blue-300" href="/profile">
                          Profile
                        </a>
                      )}
                    </div>
                    <div> | </div>
                    <div>
                      <button className="hover:text-blue-300" onClick={logout}>
                        Logout
                      </button>
                    </div>
                  </>
