...
const TableKedatangan = ({tipe, setIsOpenModalDelete, setRowId, reloadData, setIsOpenModalEdit}) => {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch(
          `http://localhost:3001/api/histories/datang?page=${pagination.pageIndex}&limit=${pagination.pageSize}`,
          {
            headers: {
...
export default TableKedatangan;
