      ...
      <div className="flex justify-between items-centergap-[100px] absolute">
        ...
        <div className=" flex justify-center gap-[50px] text-[24px] font-bold mt-10 ">
          <ul className="flex justify-center gap-[50px] border rounded-2xl px-5 py-2">
            <li>
              <a className="hover:text-[#1A719C]" href="/arrival">
                FORM KEDATANGAN
              </a>
            </li>
          ...
          <div className="flex text-left text-[20px]">
            <form
              ...
              <div className="grid gap-[30px]">
                <div>
                  <div className="font-bold pl-[17px]">Nama Agen Kapal</div>
                ...
                <div>
                  <div className="font-bold pl-[17px]">Perusahaan Agen Kapal</div>
                  <div className="pt-[11px]">
                    <input
                      type="text"
                ...
                <div>
                  <div className="font-bold pl-[17px]">IMO Number</div>
                  <div className="pt-[11px]">
                    <input
                      type="text"
                      value={imo_number}
                ...
                <div>
                  <div className="font-bold pl-[17px]">Nama Kapal</div>
                  <div className="pt-[11px]">
                    <input
                      type="text"
                      value={nama_kapal}
                ...
                <div>
                  <div className="font-bold pl-[17px]">Kebangsaan Kapal</div>
                  <div className="pt-[11px]">
                    <input
                      type="text"
                ...
                <div>
                  <div className="font-bold pl-[17px]">Pelabuhan Asal Kapal</div>
                  <div className="pt-[11px]">
                    <input
                      type="text"
                ...
                <div>
                  <div className="font-bold pl-[17px]">Pelabuhan Tujuan Kapal</div>
                  <div className="pt-[11px]">
                    <input
                      type="text"
                ...
                <div>
                  <div className="font-bold pl-[17px]">Lokasi Pelayanan</div>
                ...
                <div>
                  <div className="font-bold pl-[17px]">Jadwal Keberangkatan Kapal</div>
                  <div className="pt-[11px] relative">
                    <input
                      type="date"
                ...
                <div>
                  <div className="font-bold pl-[17px]">Tujuan Keberangkatan</div>
                  <div className="pt-[11px] relative">
                    <select
                      className="pl-[17px] bg-[#83B3CA] placeholder-[#5C5C68] w-[594px] h-[65px] rounded-[20px] appearance-none"
                ...
                <div>
                  <div className="font-bold pl-[17px]">Upload Dokumen</div>
                  <div className="pt-[11px]">
                    <input
                      type="file"
